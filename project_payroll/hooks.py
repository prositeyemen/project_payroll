...
# app_include_icons = "project_payroll/public/icons.svg"
...
# before_uninstall = "project_payroll.uninstall.before_uninstall"
# after_uninstall = "project_payroll.uninstall.after_uninstall"
...
# before_app_install = "project_payroll.utils.before_app_install"
# after_app_install = "project_payroll.utils.after_app_install"
...
# before_app_uninstall = "project_payroll.utils.before_app_uninstall"
# after_app_uninstall = "project_payroll.utils.after_app_uninstall"
...
override_doctype_class = {
	"Salary Structure Assignment": "project_payroll.overrides.salary_structure_assignment.SalaryStructureAssignmentCustom",
    "Salary Slip":"project_payroll.overrides.salary_slip.SalarySlipCustom"
}
...
# Request Events
# ----------------
# before_request = ["project_payroll.utils.before_request"]
# after_request = ["project_payroll.utils.after_request"]

# Job Events
# ----------
# before_job = ["project_payroll.utils.before_job"]
# after_job = ["project_payroll.utils.after_job"]
